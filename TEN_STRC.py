...
def TEN_STRC_COLS(optLayID):
    subLayName = "Structure"
    ...
    return None
def TEN_STRC_COLS_METL(optLayID):
    subLayName = "Structure"
    subLayColor = [125,125,255]
    layName = "COLS_METL"
    layColor = [200,0,255]
    ...
    return None
def TEN_STRC_COLS_CONC(optLayID):
    subLayName = "Structure"
    subLayColor = [125,125,255]
    layName = "COLS_CONC"
...
def main():
    ...
    if (layToAdd == 1 or layToAdd == 0):
        TEN_STRC_COLS(optLayID)
    if (layToAdd == 2 or layToAdd == 0):
        TEN_STRC_CORE(optLayID)
    if (layToAdd == 3 or layToAdd == 0):
        TEN_STRC_BEAM(optLayID)
    if (layToAdd == 4 or layToAdd == 0):
        TEN_STRC_COLS_METL(optLayID)
    if (layToAdd == 5 or layToAdd == 0):
        TEN_STRC_COLS_CONC(optLayID)
    if (layToAdd == 6 or layToAdd == 0):
        TEN_STRC_SLAB(optLayID)
    return None
